...
function extractReadableContent() {
  ...
  const scriptsAndStyles = bodyClone.querySelectorAll('script, style, nav, footer, header, aside');
  ...
  const mainContentElements = bodyClone.querySelectorAll('article, main, .content, .main, #content, #main');
